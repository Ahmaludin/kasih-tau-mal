  ...
  return (
    <section className={styles.container}>
      <div className={styles.content}>
        ...
        <br />
        <p>
          Dari banyak kategori artikel, pembaca bisa melakukan filtering artikel
          yang ingin dibaca. Melalui kategori entertainment pembaca bisa
          mengetahui informasi terkini dalam bidang hiburan di Indonesia maupun
          luar negeri.
        </p>
        <br />
        <p>
