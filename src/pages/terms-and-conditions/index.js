  ...
  return (
    <>
      <MetaHead
        ...
        description="Terms and conditions website kasihtaumal"
        url={`${process.env.WEB_URL}terms-and-conditions`}
      />
      ...
      <section className={styles.container}>
        <div className={styles.content}>
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to kasihtaumal.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to kasihtaumal, accessible from{' '}
                <a
                  href="kasihtaumal.com"
          ...
          <p>
            ...
            <Link href={'/contacts'} style={{ color: '#0c33b3' }}>
              contact us
            </Link>
          </p>
        </div>
